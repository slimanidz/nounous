...
const Histoire1 = () => {
  ...
  return (
    // <Page>
    <div className="w-full h-screen flex flex-col justify-between  gap-3   ">
      <Header />{" "}
      <button
        className={
          num === 1
      ...
      <div className="flex flex-col justify-center items-center gap-3 ">
        <ImageSrc
          width="400"
          height="80"
          className="w-[80%] h-[400px] md:h-[500px] "
          alt="histoire"
        ...
        {num === 5 ? (
          <h1 className="text-3xl text-center">
            Au camping de la clairière, personne ne veut partager sa tente avec
            moi.
        ...
        {num === 7 ? (
          <h1 className="text-3xl text-center">
            La petite souris voulait m&rsquo;aider et comme elle savait coudre,
            <br /> elle m&rsquo;a fait une jolie chemise.
          </h1>
        ) : null}
        {num === 8 ? (
          <h1 className="text-3xl text-center">
            Tout fier, je suis allé montrer ma chemise aux autres animaux. Mais
            ils ont crié :<br /> — Ne t&rsquo;approche pas de nous ! Tu as des
            piquants pointus dans le dos !<br /> — Des piquants ? Mais non, je
            n&rsquo;en ai pas...
          </h1>
        ) : null}
        {num === 9 ? (
        ...
        {num === 13 ? (
          <h1 className="text-3xl text-center">
            En effet, dès qu&rsquo;ils m&rsquo;ont vu avec mes piquants couleur
            de feu,
            <br />
