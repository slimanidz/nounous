    ...
    <Dashboard>
      ...
      {/* <div className="w-full h-screen flex flex-col justify-between  gap-3  mt-10 md:mt-20    ">
        ...
        <div className="flex flex-col justify-center items-center gap-3 ">
          ...
          {num === 3 ? (
            <h1 className="text-3xl text-center">
              ... mais ce que j'aime pas trop, <br /> ce sont ces longs
              poils durs que j'ai sur tout mon dos et qu'on appelle
              des piquants.
            </h1>
          ) : null}
          {num === 4 ? (
            <h1 className="text-3xl text-center">
              Les autres non plus ne les aiment pas, d'ailleurs. Sur
              l'aire de
              <br />
          ...
          {num === 6 ? (
            <h1 className="text-3xl text-center">
              Un jour que j'étais tout seul, une petite souris s'est
              approchée de moi et m'a dit :<br /> — Groudou, avec tes
              piquants, <br />
          ...
          {num === 7 ? (
            <h1 className="text-3xl text-center">
              La petite souris voulait m'aider et comme elle savait
              coudre,
              <br /> elle m'a fait une jolie chemise.
            </h1>
          ) : null}
          {num === 8 ? (
            <h1 className="text-3xl text-center">
              Tout fier, je suis allé montrer ma chemise aux autres animaux.
              Mais ils ont crié :<br /> — Ne t'approche pas de nous ! Tu
          ...
          {num === 10 ? (
            <h1 className="text-3xl text-center">
              J'avais envie de pleurer, je ne savais plus quoi faire. Mais
              la souris avait une idée.
              <br /> — Ne t'en fais pas, mon très piquant ami,
              <br /> j'ai la solution...{" "}
            </h1>
          ) : null}
          {num === 11 ? (
            <h1 className="text-3xl text-center">
              Munie de peinture orange et rouge, elle s'est mise à me
          ...
          {num === 12 ? (
            <h1 className="text-3xl text-center">
              — et voilà, n'aie plus peur, tu peux aller retrouver les
              autres,
          ...
          {num === 13 ? (
            <h1 className="text-3xl text-center">
              En effet, dès qu'ils m'ont vu avec mes piquants
              couleur de feu,
              <br />
              ils m'ont admiré et auraient bien voulu que la souris les
              peigne eux aussi !
            </h1>
          ) : null}
          {num === 14 ? (
          ...
          {num === 15 ? (
            <h1 className="text-3xl text-center">
              et maintenant je suis très content d'avoir des piquants !{" "}
            </h1>
          ) : null}
        </div>
        <button
